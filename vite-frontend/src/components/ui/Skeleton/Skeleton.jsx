...
export const CardSkeleton = () => {
  return (
    <div className="bg-surface-container border border-glass-border rounded-xl p-5 mb-4">
...
export const TableSkeleton = ({ rows = 5, cols = 4 }) => {
  return (
    <div className="bg-surface-container border border-glass-border rounded-3xl overflow-hidden mt-6">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-glass-border bg-deep-charcoal/50">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900">
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-6">
        <div className="bg-surface-container border border-glass-border rounded-3xl p-6 flex justify-between items-start gap-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-surface-container border border-glass-border rounded-2xl p-4 flex items-center gap-4">
        ...
        <div className="bg-surface-container border border-glass-border rounded-3xl p-6">
          ...
          <div className="space-y-4">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex justify-between py-2 border-b border-glass-border">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col lg:flex-row gap-12 mt-10">
            ...
            <div className="lg:w-1/3">
              <div className="bg-deep-charcoal border border-glass-border p-6 rounded-3xl sticky top-24 shadow-2xl space-y-6">
