        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2 text-sm">
              We've sent a 6-digit verification code to <span className="font-semibold text-white">{state?.email}</span>
            </p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  maxLength={6}
                  placeholder="123456"
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-center tracking-[0.5em] text-white font-bold placeholder-slate-500 text-lg focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all duration-200"
                />
              </div>
              {errors.otp && (
          ...
          <div className="text-center mt-6">
            <button
              ...
              className="text-sm font-medium text-indigo-400 hover:text-indigo-300 transition-colors disabled:text-slate-500 disabled:hover:text-slate-500"
            >
